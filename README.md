...
- [ ] Describe Middleware?
      They are gatekeeps in a way. The middleware function happens before the api calls or just about anything.

- [ ] Describe a Resource?
      Anything that holds data in a database.

* [ ] What can the API return to help clients know if a request was successful?
      An alert message.

* [ ] How can we partition our application into sub-applications?
      By using routing we can make seperate files to keep thing organized.
